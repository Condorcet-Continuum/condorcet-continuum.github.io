---
title: "Generators"
description: "Documentation du module code_generator/generators"
category: "technical"
sidebar_group: "CODE_GENERATOR"
---
...
| -------------- | ------------------- | -------------------------- | ---------------------------------------------------------- |
| **Rust**       | `rust_gen.rs`       | `rust/actor`               | Génère des `struct` Rust avec sérialisation.               |
